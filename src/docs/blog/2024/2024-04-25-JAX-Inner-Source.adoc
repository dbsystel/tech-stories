...
*English Video*
++++
<iframe class="video-iframe" frameborder="0" src="https://www.youtube-nocookie.com/embed/9e-K9G0O2DQ?si=sucnGmVocgsFKIey" title="InnerSource@DB: A Story About Open Source Practices at Deutsche Bahn
 mit Carsten Hoffmann" allowfullscreen="true" style="border: 0px; background: padding-box padding-box rgba(0, 0, 0, 0.1); margin: 0px; padding: 0px; border-radius: 6px;  width: 100%; height: auto; aspect-ratio: 560 / 315;" data-ratio="1.7777777777777777"></iframe>
++++
